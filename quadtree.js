...
class QuadTreeNode {
        ...
        if (this.bounds.intersects(rect)) {
            if (
                ...
                if (isCircle)
                    ...
                    results.push(
                        ...this.children.filter(
                            (child) => rect.contains(child) && child != boid
                        )
                    );
            } else {
    ...
    render() {
        ...
        if (this.topLeft !== null) this.topLeft.render();
        if (this.topRight !== null) this.topRight.render();
        if (this.bottomLeft !== null) this.bottomLeft.render();
        if (this.bottomRight !== null) this.bottomRight.render();
    }
}
